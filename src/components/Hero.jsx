...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-screen h-[120vh] mx-auto">
      ...
      >
        ...
        <div>
          ...
          >
            <motion.button
              className="bg-[#915eff] text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-[#915eff]/50"
              whileHover={{
                scale: 1.05,
            ...
            <motion.button
              className="border-2 border-[#915eff] text-[#915eff] px-6 py-3 rounded-lg font-semibold hover:bg-[#915eff] hover:text-white transition-all duration-300"
      ...
      <div className="absolute inset-0 z-0 top-[280px] sm:top-[220px] md:top-[180px] lg:top-[160px]">
        <ComputersCanvas />
      </div>
      ...
      >
        <a href="#about">
          <motion.div
            className="w-[35px] h-[64px] rounded-3xl border-4 border-secondary flex justify-center items-start p-2 hover:border-[#915eff] transition-colors duration-300"
            whileHover={{ scale: 1.1 }}
          >
            <motion.div
              animate={{
